...
class DocumentService:
    """Orchestrates validation, storage, and persistence for documents."""
    ...
    async def upload(self, file: UploadFile) -> Document:
        """Validate and store an uploaded PDF, then persist metadata."""
        ...
        logger.info("Document uploaded id=%s filename=%s", document.id, original_filename)
        return document
